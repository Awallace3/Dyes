...
def lsf(cam,pbe,data,contrib1,contrib2,num):
    ...
    print(molname)
    #print(pbe[molname])
    if cam[molname]== "CAM or PBE is not completed" or pbe[molname] == "CAM or PBE is not completed":
        print(molname)
...
def jsoncreator(cam,pbe,lsf,data,num):
    ...
    data["molecules"][num]["STATS"]={"nm":lsf[0][data["molecules"][num]["name"]],"eV":lsf[1][data["molecules"][num]["name"]]}
