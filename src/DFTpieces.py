...
def main():
    ...
    #path_to_benchmark = '../DFTpieces/Backbone/'
    SMILES = input('What is the SMILES str for the piece ')
...
#    name = 'TESTTTTT'
    ...
    if 'ea' in name:
        ...
        path_to_benchmark = '../DFTpieces/eAcceptor/'
      #  print('AAAA')
    #    os.chdir(path_to_benchmark)
#    SMILES = 'CCCC'
#    name = 'TESTTTTT'
    ...
    if 'ed' in name:
        ...
        path_to_benchmark = '../DFTpieces/eDonor/'
      #  print('AAAA')
    #    os.chdir(path_to_benchmark)
#    SMILES = 'CCCC'
#    name = 'TESTTTTT'
