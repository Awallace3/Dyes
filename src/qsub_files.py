...
if __name__ == "__main__":
    ...
    resubmit =  ['TH304', 'C258', 'BTD-1', 'NKX-2883', 'WS-8', 'HKK-BTZ4']
    resubmit =  [ 'NKX-2883', 'WS-8', 'HKK-BTZ4']
   # broken_resubmit('../Benchmark/results',resubmit)
    
    fix_broken(resubmit,'../Benchmark/results')
