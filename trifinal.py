from tri_SMILES_COMB import SMILES_COMB
...
def smilesRingCleanUp(f, s, t, j, k):
    smi1, na1, form1 = f
    smi2, na2, form2 = s
    smi3, na3, form3 = t
    smi4, na4, form4 = j
...
#    formalName = form1 + "::" + form2 + "::" + form3 + "::" + form4 + "::" + form5
    """
    if you want the three donors to just be the same uncomment below
    """
    name = na1 + "_" + na4 + '_' + na5 + '_' + na2 + "_" + na3
    formalName = form1 + "::" + form2 + "::" + form3 + "::" + form4 + "::" + form5
    smi1 = f[0]
    ...
    smi5 = k[0]
    print(name)
    line = SMILES_COMB(smi1, smi2, smi3, smi4, smi5)
    """
    if na1 == na2 == na3:
        name = na1 + "_" + na4 + '_' + na5 + '_' + na2 + "_" + na3
        formalName = form1 + "::" + form2 + "::" + form3 + "::" + form4 + "::" + form5
...
def generateSMILESinputs(smiles_tuple_list, ):
    ...
    for num, i in enumerate(smiles_tuple_list):
        ...
        line, name, formalName = smilesRingCleanUp(first, second, third, fourth, fifth)
        print(name, line)
        smiles[name] = line
...
def main():
    ...
    #  #banned = ["42b", "26b", "27b"]
    banned = ['7ea','9ea','10ea','11ea','13ea','1ed','2ed','3ed','12ed','21ed']
    three_types = [
          "trieDonors",
          "trieDonors",
          "trieDonors",
    ...
    monitor_jobs = generateMolecules(
         ...
         mem_pbs_opt,
         cluster,
         results_json="json_files/tri_donor.json",
     )
